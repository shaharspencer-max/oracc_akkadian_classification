...
if __name__ == '__main__':
    ...
    source_data_path = r"tablets_full_merged_with_sender_city_and_genre.csv"
    ...
    if os.path.exists(source_data_path):
        ...
        output_path = "gemini_predictions_first_millenium_with_candidates_list_no_timeframe_no_gn_no_en.csv"
