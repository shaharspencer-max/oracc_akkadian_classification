...
# API_KEYS = [            "AIzaSyC2eokQCXyVWkyHCpQ4d1fjic91BvDkh6o",
...
class CallGemini:
    ...
    def classify_city(user_text: str, api_key: str):
        ...
        Input Format:
        TEXT - the Akkadian text to analyze. Proper names may be masked (examples: DN, PN, GN). The text was written in the first millenium BCE.

        Instructions:
        1. Initial Scan: Carefully read the text. Understand what is written. 
        2. Analyze indicative features: Deeply and carefully understand and analyze the text, the content, the subject matters, etc. 
...
if __name__ == '__main__':
    ...
    source_data_path = "scripts and results - 6_11_2025/first_millenium_df.csv"
    ...
    if os.path.exists(source_data_path):
        ...
        output_path = "gemini_predictions_first_millenium_with_candidates_list_no_timeframe.csv"
